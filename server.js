...
( async() => {
    ...
    const user1 =  await createUser({ firstName: "Andres",lastName: "Valenzuela ", email:"avalenzuela@correo.com"});
    const user2 =   await createUser({ firstName: "Marco",lastName: "Marshall ", email:"mmarshall@correo.com"});
    const user3 =   await createUser({ firstName: "Leonor",lastName: "Rojas ", email:"lrojas@correo.com"});
    const user4 =  await createUser({ firstName: "Camila",lastName: "Herrera ", email:"cherrera@correo.com"});
    ...
    await updateUserById(2,{lastName:"Romero"});
